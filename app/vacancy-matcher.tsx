...
const requirements: Requirement[] = [
  ...
  { id: 'delivery', label: { ru: 'CI/CD и инфраструктура', en: 'CI/CD and infrastructure' }, keywords: ['ci/cd', 'cicd', 'gitlab ci', 'jenkins', 'инфраструктур'], status: 'confirmed', evidence: { ru: 'Настройка CI/CD для новых сервисов, опыт GitLab CI и Jenkins.', en: 'CI/CD setup for new services, with GitLab CI and Jenkins experience.' } },
  { id: 'containers', label: { ru: 'Docker / Kubernetes', en: 'Docker / Kubernetes' }, keywords: ['docker', 'kubernetes', 'k8s', 'кубер'], status: 'confirmed', evidence: { ru: 'Используются в текущей инфраструктурной работе.', en: 'Used in current infrastructure work.' } },
  ...
  { id: 'ai', label: { ru: 'AI-assisted development', en: 'AI-assisted development' }, keywords: [' ai ', 'ии', 'artificial intelligence', 'llm', 'copilot', 'генерац'], status: 'confirmed', evidence: { ru: 'Генерация кода и внедрение AI-практик в командную разработку.', en: 'Code generation and introducing AI practices into team development.' } },
